...
public class TestMaxMessage {
	...
	public void testSend() throws Exception {
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.getProducer().newTransaction("mytest001", "mytest001Name" + i % 10);
	...
	public void testMySend() throws Exception {
		Transaction t = Cat.getProducer().newTransaction("mytest003", "mytest003Name");
		Cat.logEvent("myTestEvent2","myTestEventName0",Message.SUCCESS,"mykey mykeyvalue");
		Transaction t2 = Cat.getProducer().newTransaction("mytest00210", "mytest00210Name");
		t2.addData("t2Data","88");
		Cat.logEvent("myTestEvent","myTestEventName",Message.SUCCESS,"mykey mykeyvalue");
		t2.complete();
        //t.addChild(t2);
        t.complete();
		Thread.sleep(10 * 1000);
	...
	@Test
	public void testMySendExcepiton() throws Exception {
		Transaction t = Cat.getProducer().newTransaction("mytestException2", "mytestExceptionName2");
		try{

			Cat.logEvent("exceptionEvent2","excetionEvent2",Message.SUCCESS,"exceptionEventData & value");
